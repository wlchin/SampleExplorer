...
def test_transcriptome_search():
    ...
    assert series_of_interest.equals(series_of_interest2)
...
def test_supporting_transcriptome_transcriptome_expansion():
    _, series_of_interest = new_query_db.transcriptome_search(test_geneset, nsamples = 10)
    output = new_query_db.get_transcriptome_series_of_relevance_from_series(series_of_interest, k=5)
    sup = new_query_db.transcriptome_search_with_transcriptome_expansion(test_geneset, 10, 5)
...
def test_supporting_transcriptome_semantic_expansion():
    ...
    sup = new_query_db.transcriptome_search_with_semantic_expansion(test_geneset, 10, 5)
    assert output.shape[0] == sup.shape[0]

def test_supporting_semantic_semantic_expansion():
    _, series_of_interest = new_query_db.semantic_search("Trans-chromosomal regulation lincRNA", k = 10)
    output = new_query_db.get_semantic_series_of_relevance_from_series(series_of_interest, k = 5)
    sup = new_query_db.semantic_search_with_semantic_expansion("Trans-chromosomal regulation lincRNA", 10, 5)
    assert output.shape[0] == sup.shape[0]

def test_supporting_semantic_transcriptomic_expansion():
    _, series_of_interest = new_query_db.semantic_search("Trans-chromosomal regulation lincRNA", k = 10)
    output = new_query_db.get_transcriptome_series_of_relevance_from_series(series_of_interest, k = 5)
    sup = new_query_db.semantic_search_with_transcriptome_expansion("Trans-chromosomal regulation lincRNA", 10, 5)
    assert output.shape[0] == sup.shape[0]
...
def test_search_function():
    ...
    df2 = new_query_db.semantic_search_with_transcriptome_expansion("Trans-chromosomal regulation lincRNA", 5,5)
    assert df.series.equals(df2)
...
def test_search_function2():
    ...
    df2 = new_query_db.semantic_search_with_semantic_expansion("Trans-chromosomal regulation lincRNA", 5,5)
    assert df.series.equals(df2)
...
def test_search_function3():
    ...
    df2 = new_query_db.transcriptome_search_with_semantic_expansion(test_geneset, 5,5)
    assert df.series.equals(df2)
...
def test_search_function4():
    ...
    df2 = new_query_db.transcriptome_search_with_transcriptome_expansion(test_geneset, 5,5)
    assert df.series.equals(df2)